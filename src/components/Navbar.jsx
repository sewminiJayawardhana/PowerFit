    ...
    <div className='absolute top-0 left-0 w-full z-10'>
      <div className='container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent'>
        ...
        <ul className='hidden md:flex gap-7 text-white'>
          ...
          <a href="#Header" className='cursor-pointer hover:text-gray-400'>Programs</a>
          <a href="#Header" className='cursor-pointer hover:text-gray-400'>Gallery</a>
      ...
      <div className='md:hidden fixed w-full right-0 top-0 bottom-0 overflow-hidden bg-white transition-all'>
        ...
        <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium'>
          ...
          <a href="#Programs" className='px-4 py-2 rounded-full inline-block '>Programs</a>
